...
text_temp = "Hello World!\nHello World!\nHello World!\nHello World!\nHello World!\nHello World!\nHello World!"
len_txt = 200 + len(text_temp.split("\n")) * 10

def alert():
    my_alert = CTkAlert(state="info", title="Title", body_text=text_temp, btn1="Ok", btn2="Cancel", height=len_txt)
    answer = my_alert.get()  # get answer
    print(answer, len(text_temp.split("\n")))
...
def ctk_popup():
    ...
    popup_menu = CTkPopupMenu(master=preview_frame, width=250, height=270, title="Title", corner_radius=8,
                              border_width=0)
